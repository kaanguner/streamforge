...
public class FraudDetectorTest {
    ...
    private OrderEvent createOrderEvent(String orderId, String userId, double amount, long timestamp) {
    ...
    void testHighValueFirstOrderDetection() {
        FraudDetector.HighValueFirstOrderDetector detector = new FraudDetector.HighValueFirstOrderDetector();
    ...
    void testHighValueOrderExistingUser() {
        ...
        OrderEvent secondOrder = createOrderEvent("ORD-003", "USR-NORMAL", 75000.0,
    ...
    void testAlertCreation() {
        FraudAlert alert = FraudDetector.createAlert(
                highValueOrder,
    ...
    void testNullUserId() {
        OrderEvent nullUserOrder = createOrderEvent("ORD-NULL", null, 1000.0,
                Instant.now().toEpochMilli());
