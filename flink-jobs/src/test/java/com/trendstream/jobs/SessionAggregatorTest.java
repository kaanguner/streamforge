...
public class SessionAggregatorTest {
    ...
    private ClickstreamEvent createEvent(String userId, String sessionId, String eventType,
    ...
    void testAccumulatePageViews() {
        ...
        acc.add(createEvent("USR-001", "SESS-001", "page_view",
    ...
    void testUnknownEventType() {
        ClickstreamEvent unknownEvent = createEvent("USR-001", "SESS-001", "unknown_type",
                Instant.now().toEpochMilli(), 0);
    ...
    void testNullPrice() {
        ClickstreamEvent nullPriceEvent = createEvent("USR-001", "SESS-001", "purchase",
                Instant.now().toEpochMilli(), 0);
