 ...
 *
 * <p>Entry point for running TrendStream Flink jobs. Supports running different jobs via command
 * line arguments.
 *
 * <p>Usage: flink run trendstream-1.0.jar --job SessionAggregator flink run trendstream-1.0.jar
 * --job FraudDetector flink run trendstream-1.0.jar --job RevenueCalculator
 */
