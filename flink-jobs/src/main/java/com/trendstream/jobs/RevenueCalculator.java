 ...
 *
 * <p>Real-time revenue and GMV (Gross Merchandise Value) calculation. Demonstrates
 * Trendyol-relevant patterns: - Tumbling window aggregation - Multi-metric calculation -
 * Category-level breakdown - Real-time KPI computation
 */
public class RevenueCalculator {
  ...
  public static void main(String[] args) throws Exception {
    ...
    DataStream<RevenueMetrics> revenueMetrics =
        orders
  ...
  public static class RevenueMetrics implements Serializable {
    ...
    public void setAverageOrderValue(Double aov) {
      this.averageOrderValue = aov;
    }
    ...
    public void setRevenueByCategory(Map<String, Double> rbc) {
      this.revenueByCategory = rbc;
    }
    ...
    public void setOrdersByRegion(Map<String, Integer> obr) {
      this.ordersByRegion = obr;
    }

    public Integer getFirstTimeOrders() {
      return firstTimeOrders;
    }

    public void setFirstTimeOrders(Integer fto) {
      this.firstTimeOrders = fto;
    }
  ...
  public static class RevenueAggregateFunction
    ...
    public RevenueAccumulator merge(RevenueAccumulator a, RevenueAccumulator b) {
      ...
      b.categoryRevenue.forEach((k, v) -> merged.categoryRevenue.merge(k, v, Double::sum));

      merged.regionOrders.putAll(a.regionOrders);
      b.regionOrders.forEach((k, v) -> merged.regionOrders.merge(k, v, Integer::sum));
