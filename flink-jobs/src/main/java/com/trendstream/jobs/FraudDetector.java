 ...
 * 
 * Real-time fraud detection using Complex Event Processing (CEP).
 ...
 * 
 * Detection Patterns:
 * 1. RAPID_ORDERS: >3 orders from same user within 5 minutes
 * 2. HIGH_VALUE_FIRST_ORDER: First order > 5000 TRY
 * 3. SUSPICIOUS_PATTERN: Order > 2000 TRY right after session start
 */
public class FraudDetector {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<FraudAlert> rapidOrderAlerts = rapidOrderStream.select(
            new PatternSelectFunction<OrderEvent, FraudAlert>() {
                ...
                public FraudAlert select(Map<String, List<OrderEvent>> pattern) {
                    ...
                    FraudAlert alert = new FraudAlert(
                        ...
                        0.85,
                        String.format(
                            "User placed 3 orders within 5 minutes. First order: %s, Last order: %s",
        ...
        // =====================================
        DataStream<FraudAlert> highValueFirstOrderAlerts = orders
        ...
        DataStream<String> alertJson = allAlerts
     ...
     * Tracks whether each user has placed an order before.
     */
