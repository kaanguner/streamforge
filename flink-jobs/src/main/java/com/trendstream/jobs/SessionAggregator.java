 ...
 * 
 * Aggregates user sessions using session windows with 30-minute inactivity gap.
...
public class SessionAggregator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<ClickstreamEvent> clickstream = env
            .fromSource(
                source,
                WatermarkStrategy
        ...
        DataStream<SessionAggregate> sessions = clickstream
        ...
        DataStream<String> sessionJson = sessions
            .map(session -> objectMapper.writeValueAsString(session))
     ...
     * Accumulates clickstream events into session aggregates.
     */
    public static class SessionAggregateFunction 
            ...
            switch (event.getEventType()) {
                ...
                case "PURCHASE":
                    ...
                    if (event.getPrice() != null) {
                        acc.totalRevenue += event.getPrice() * 
        ...
        public SessionAccumulator merge(SessionAccumulator a, SessionAccumulator b) {
            ...
            b.categoryCounts.forEach((k, v) -> 
                merged.categoryCounts.merge(k, v, Integer::sum)
            );
