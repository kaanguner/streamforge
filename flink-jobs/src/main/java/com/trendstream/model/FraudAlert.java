...
/** Fraud Alert Represents a fraud detection alert generated by the FraudDetector. */
public class FraudAlert implements Serializable {
  ...
  public FraudAlert(
      String alertId, String userId, AlertType alertType, Double riskScore, String description) {
