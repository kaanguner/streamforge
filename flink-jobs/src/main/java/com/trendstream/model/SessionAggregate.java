...
/**
 * Session Aggregate
 * Represents aggregated session data computed by SessionAggregator.
 */
public class SessionAggregate implements Serializable {
    ...
    public Integer getAddToCartCount() { return addToCartCount; }
    public void setAddToCartCount(Integer addToCartCount) { this.addToCartCount = addToCartCount; }
